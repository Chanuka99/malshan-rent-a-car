...
export const CarSchema = z.object({
  ...
  year: z.number().min(2000, 'Year must be 2000 or later').max(2026, 'Year must be 2026 or earlier'),
  type: z.enum(['economy', 'suv', 'luxury', 'van']),
  seats: z.number().min(2, 'Min 2 seats').max(12, 'Max 12 seats'),
